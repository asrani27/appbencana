...
@section('page-title', 'Tambah Pemeriksaan Medis')
@section('page-subtitle', 'Tambah data pemeriksaan medis baru')
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-300 overflow-hidden">
    <div class="p-6 border-b border-gray-300">
        <h3 class="text-lg font-semibold text-gray-800">Form Tambah Pemeriksaan Medis</h3>
        <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah untuk menambahkan data pemeriksaan medis</p>
    </div>

    <form action="{{ route('admin.pemeriksaan.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="nadi" id="nadi" value="{{ old('nadi') }}"
            ...
            <div>
                ...
                <input type="text" name="respirasi" id="respirasi" value="{{ old('respirasi') }}"
            ...
            <div>
                ...
                <input type="number" step="0.1" name="suhu" id="suhu" value="{{ old('suhu') }}"
            ...
            <div>
                ...
                <textarea name="keluhan" id="keluhan" rows="3"
                    ...
                    placeholder="Deskripsikan keluhan korban">{{ old('keluhan') }}</textarea>
                @error('keluhan')
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="diagnosa_awal" id="diagnosa_awal" rows="3"
                    ...
                    placeholder="Diagnosa awal">{{ old('diagnosa_awal') }}</textarea>
                @error('diagnosa_awal')
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
