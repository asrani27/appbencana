...
@section('page-subtitle', 'Tambah data rumah sakit baru')
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-300 overflow-hidden">
    <div class="p-6 border-b border-gray-300">
        <h3 class="text-lg font-semibold text-gray-800">Form Tambah Rumah Sakit</h3>
        <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah untuk menambahkan data rumah sakit</p>
    </div>

    <form action="{{ route('admin.rumahsakit.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="kapasitas_igd" id="kapasitas_igd" value="{{ old('kapasitas_igd', 0) }}"
