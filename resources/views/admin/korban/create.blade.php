...
@section('page-title', 'Tambah Korban')
@section('page-subtitle', 'Tambah data korban baru')
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-300 overflow-hidden">
    <div class="p-6 border-b border-gray-300">
        <h3 class="text-lg font-semibold text-gray-800">Form Tambah Korban</h3>
        <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah untuk menambahkan data korban baru</p>
    </div>

    <form action="{{ route('admin.korban.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="umur" id="umur" value="{{ old('umur') }}" min="0" max="150"
            ...
            <div>
                ...
                <select name="status_identitas" id="status_identitas" required
                    ...
                    <option value="{{ $key }}" {{ old('status_identitas')==$key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="lokasi_ditemukan" id="lokasi_ditemukan" value="{{ old('lokasi_ditemukan') }}"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="kondisi_awal" id="kondisi_awal" rows="3"
                    ...
                    placeholder="Deskripsikan kondisi awal korban">{{ old('kondisi_awal') }}</textarea>
                @error('kondisi_awal')
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="foto" id="foto" value="{{ old('foto') }}"
