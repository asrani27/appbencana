...
<body>
    <div class="header">
        <h1>LAPORAN DATA KORBAN BENCANA</h1>
    ...
    <div class="summary">
        <p><strong>Total Record:</strong> {{ $korban->count() }} korban</p>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 15%">Bencana</th>
                <th style="width: 8%">JK</th>
                <th style="width: 8%">Umur</th>
                <th style="width: 12%">Tgl Ditemukan</th>
                <th style="width: 34%">Kondisi Awal</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><span class="jk-badge">{{ $item->jenis_kelamin }}</span></td>
                <td>{{ $item->umur }} th</td>
            ...
            @empty
            <tr>
                <td colspan="7" style="text-align: center; color: #64748b;">Tidak ada data korban</td>
            </tr>
            @endforelse
        </tbody>
    </table>
